...
export type Row = {
  ...
  socialPaid:number; socialBase:number; socialRate:number; socialDue:number;
  fundPaid:number; fundBase:number; fundRate:number; fundDue:number;
};
...
export type QuickSetup = {
  ...
  fundHasPaid:boolean; fundPaid:number; fundPaidStartMonth:string; fundPaidEndMonth:string; fundBase:number; fundRate:number; fundPersonalRate:number;
...
export const defaultSetup:QuickSetup = {
  ...
  socialHasPaid:false,socialPaid:0,socialActualBase:0,socialPaidStartMonth:"",socialPaidEndMonth:"",socialBase:0,socialRate:27.6,
  ...
  fundHasPaid:false,fundPaid:0,fundPaidStartMonth:"",fundPaidEndMonth:"",fundBase:0,fundRate:5,fundPersonalRate:5,
